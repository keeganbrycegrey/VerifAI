...
FastAPI Backend (Railway)
    ...
    │       |--- Image: Gemini 1.5 Flash - Pillow OCR via Gemini
    │       L--- URL: httpx fetch + BeautifulSoup4 extraction
    │
    |--- Claim Extractor - Gemini 1.5 Flash via Gemini
    │
    ...
    │
    |--- Verdict Generator - Gemini 1.5 Flash via Gemini
...
| Model | Provider | Role |
|---|---|---|
| Gemini 1.5 Flash | Google / Gemini | Claim extraction and verdict generation |
| Gemini 1.5 Flash - Pillow | Google / Gemini | Image OCR |
...
|---|---|
| Gemini 1.5 Flash | Claim extraction and bilingual verdict generation |
| Gemini 1.5 Flash - Pillow | Image OCR for screenshots and forwarded images |
